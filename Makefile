...
TEST_IBD_VALIDATOR   = test/unit/test_ibd_validator
...
$(TEST_SYNC): test/unit/test_sync.c src/protocol/sync.c src/protocol/download_mgr.c src/protocol/peer.c src/protocol/serialize.c src/protocol/messages.c src/consensus/chainstate.c src/consensus/utxo.c src/consensus/block.c src/consensus/tx.c src/consensus/serialize.c src/consensus/block_validate.c src/consensus/tx_validate.c src/consensus/script.c src/consensus/sig_verify.c src/consensus/merkle.c src/crypto/sha256.c src/crypto/sha1.c src/crypto/ripemd160.c src/crypto/secp256k1.c src/platform/posix.c src/app/log.c src/app/node.c src/app/mining.c src/protocol/mempool.c src/protocol/discovery.c src/protocol/relay.c src/consensus/consensus.c src/node/chase.c src/node/chaser.c src/node/chaser_validate.c src/node/chaser_confirm.c src/node/ibd_validator.c src/storage/block_tracker.c src/storage/blocks.c src/storage/db.c src/storage/utxo_db.c src/storage/block_index_db.c lib/sqlite/sqlite3.c $(TEST_UTILS_OBJ) $(LIBSECP_OBJS)
	$(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS)
...
$(TEST_PRUNING): test/unit/test_pruning.c src/storage/blocks.c src/storage/block_index_db.c src/storage/block_tracker.c src/storage/db.c src/app/node.c src/app/log.c src/protocol/mempool.c src/protocol/sync.c src/protocol/download_mgr.c src/protocol/discovery.c src/protocol/peer.c src/protocol/relay.c src/protocol/serialize.c src/protocol/messages.c src/consensus/consensus.c src/consensus/chainstate.c src/consensus/utxo.c src/consensus/block_validate.c src/consensus/tx_validate.c src/consensus/script.c src/consensus/sig_verify.c src/consensus/merkle.c src/consensus/block.c src/consensus/tx.c src/consensus/serialize.c src/storage/utxo_db.c src/crypto/sha256.c src/crypto/sha1.c src/crypto/ripemd160.c src/crypto/secp256k1.c src/platform/posix.c src/node/chase.c src/node/chaser.c src/node/chaser_validate.c src/node/chaser_confirm.c src/node/ibd_validator.c lib/sqlite/sqlite3.c $(TEST_UTILS_OBJ) $(LIBSECP_OBJS)
	$(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS)
...
$(TEST_IBD_VALIDATOR): test/unit/test_ibd_validator.c src/node/ibd_validator.c src/app/node.c src/app/log.c src/app/mining.c src/protocol/mempool.c src/protocol/sync.c src/protocol/download_mgr.c src/protocol/discovery.c src/protocol/peer.c src/protocol/relay.c src/protocol/serialize.c src/protocol/messages.c src/consensus/consensus.c src/consensus/chainstate.c src/consensus/utxo.c src/consensus/block_validate.c src/consensus/tx_validate.c src/consensus/script.c src/consensus/sig_verify.c src/consensus/merkle.c src/consensus/block.c src/consensus/tx.c src/consensus/serialize.c src/storage/blocks.c src/storage/block_tracker.c src/storage/db.c src/storage/utxo_db.c src/storage/block_index_db.c src/crypto/sha256.c src/crypto/sha1.c src/crypto/ripemd160.c src/crypto/secp256k1.c src/platform/posix.c src/node/chase.c src/node/chaser.c src/node/chaser_validate.c src/node/chaser_confirm.c lib/sqlite/sqlite3.c $(TEST_UTILS_OBJ) $(LIBSECP_OBJS)
	$(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS)

test: $(TEST_SHA256) $(TEST_RIPEMD160) $(TEST_SIG_VERIFY) $(TEST_SERIALIZE) $(TEST_TX) $(TEST_BLOCK) $(TEST_MERKLE) $(TEST_SCRIPT) $(TEST_STACK) $(TEST_OPCODES) $(TEST_P2SH) $(TEST_TIMELOCK) $(TEST_TX_VALIDATE) $(TEST_BLOCK_VALIDATE) $(TEST_COINBASE) $(TEST_UTXO) $(TEST_CHAINSTATE) $(TEST_CONSENSUS) $(TEST_BLOCK_STORAGE) $(TEST_DB) $(TEST_UTXO_DB) $(TEST_BLOCK_INDEX_DB) $(TEST_BLOCK_TRACKER) $(TEST_PROTOCOL) $(TEST_PROTOCOL_SERIALIZE) $(TEST_PEER) $(TEST_DISCOVERY) $(TEST_RELAY) $(TEST_SYNC) $(TEST_DOWNLOAD_MGR) $(TEST_MEMPOOL) $(TEST_NODE) $(TEST_EVENT_LOOP) $(TEST_RPC) $(TEST_LOG) $(TEST_PRUNING) $(TEST_MINING) $(TEST_INTEGRATION) $(TEST_CHASE) $(TEST_IBD_VALIDATOR)
